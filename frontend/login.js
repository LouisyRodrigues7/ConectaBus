//  Armazena o e-mail atual para o MFA
let currentEmail = "";
...
//  Função que valida o código MFA
...
//  Função para mostrar popups de alerta
function showPopup(title, message, success = true) {
  const popup = document.createElement("div");
  popup.className = "popup";

  // Define ficar acima do MFA
